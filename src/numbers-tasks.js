...
/**
 * Returns the number degree to specified power of 10.
 *
 * @param {number} num
 * @param {number} pow
 * @return {number}
 ...
 * notation degree to precision significant digits.
 *
 * @param {number} number
...
/**
 * Returns the value of a number degree to the nearest integer.
 *
 * @param {number} number
 * @return {number}
 *
